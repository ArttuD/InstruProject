...
def make_mosiac_plot(raw_image, binarized_image, filtered_image, Local_Density, Image_Coherance, Image_Orientation, vx, vy, filename, LocalSigmaKey, percentage, SpacingKey, ScaleKey, FIGSIZE, DPI, PAD, FONTSIZE_TITLE, pad_fraction, aspect):
	...
	fig, axes = plt.subplot_mosaic("ABC;DEF", figsize=(20, 15), dpi=DPI)
	...
	axes["A"].set_title('Uploaded Image', pad = 10, fontsize = 15)
	axes["A"].set_xticks([])
	axes["A"].set_yticks([])
	...
	axes["B"].set_title('Filtered Image', pad = 10, fontsize = 15)
	axes["B"].set_xticks([])
	axes["B"].set_yticks([])
	...
	axes["C"].set_title('Local Density, ' + str(percentage) + '% fibrotic', pad = 10, fontsize = 15)
	axes["C"].set_xticks([])
	axes["C"].set_yticks([])
	...
	axes["D"].set_title('Coherence', pad = 10, fontsize = 15)
	axes["D"].set_xticks([])
	axes["D"].set_yticks([])
	...
	axes["E"].set_title('Orientation', pad = 10, fontsize = 15)
	axes["E"].set_xticks([])
	axes["E"].set_yticks([])
	...
	axes["F"].set_title('Local Orientation', pad = 10, fontsize = 15)
	axes["F"].set_xticks([])
	axes["F"].set_yticks([])
